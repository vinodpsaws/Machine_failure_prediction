...
#import HF_REPO_ID from config in week_2_mls
from week_2_mls.config import HF_REPO_ID

api = HfApi()

Xtrain_path = f"hf://datasets/{HF_REPO_ID}/Xtrain.csv"
Xtest_path = f"hf://datasets/{HF_REPO_ID}/Xtest.csv"
ytrain_path = f"hf://datasets/{HF_REPO_ID}/ytrain.csv"
ytest_path = f"hf://datasets/{HF_REPO_ID}/ytest.csv"
